...
const QUICK_LINKS = [
  {
    ...
    subtitle: 'Find new insurance products',
    icon: (
        ...
        <main className="overview">
            ...
            <div className="policy-list">
              {POLICIES.map((policy) => (
                <div key={policy.id} className="policy-item">
                  <div
                    className="policy-item__icon"
                    style={{ background: policy.color, color: policy.iconColor }}
                  >
                    {policy.icon}
                  </div>
                  ...
                  <div className="policy-item__actions">
                    ...
                    <button className="policy-item__eye" aria-label="View policy">
          ...
          <div className="quick-links">
            {QUICK_LINKS.map((item) => (
              <button key={item.id} className="quick-link-card" onClick={() => { if (item.id === 'browse') onNavigate('marketplace'); if (item.id === 'claim') onNavigate('claims'); if (item.id === 'proposals') onNavigate('proposals'); }}>
                <div
